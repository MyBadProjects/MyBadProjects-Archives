...
if (phone==1) {
    ...
    if (phoneNumberFormat==1) { console.log("  Phone Number Format:"+faker.phone.phoneNumberFormat()) };
    if (phoneFormats==1) { console.log("  Phone Formats:"+faker.phone.phoneFormats()) };
